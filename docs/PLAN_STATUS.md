...
- Chat-first React UI with provider-required ask flow, generated answer card, observable trace rail, run history, source view, About page, settings, report tabs, and JSON export.
